...
<div className={styles.card}>
    <div className={styles.background} style={{
        backgroundImage: bot.backgroundURL ? `url(${bot.backgroundURL})` : `url(assets/default-bot-background.svg)`
    }} />
    <div className={styles.info}>
        <img className={styles.avatar} src={bot.avatar} />
        <div className={styles.passport}>
            <div className={styles.botname}>{bot.name.length <= 12 ? bot.name : bot.name.slice(0, 13) + "..."}</div>
