...
const Home = ({ newBots, topBots }: Props) => {
    ...
    return (
        <Layout title="Главная | Topcord" description="Bots.topcord.ru - мониторинг ботов дискорд. Вы можете подобрать для своего сервера бота из нашего списка, найти его в поиске, либо по тегам. ">
