                    ...
                    <div className={styles.info}>
                        ...
                        <div className={styles.links}>
                            {developer.social.github && (
                                <Link href={developer.social.github}>
                                    <img src="/assets/github-logo.svg" />
                                </Link>
                            )}
                            {developer.social.website && (
                                <Link href={developer.social.website}>
                                    <img src="/assets/link.svg" />
                                </Link>
                            )}
                            {developer.social.gitlab && (
                                <Link href={developer.social.gitlab}>
                                    <img src="/assets/gitlab.webp" />
                                </Link>
                            )}
                            {developer.social.kaggle && (
                                <Link href={developer.social.kaggle}>
                                    <img src="/assets/kaggle.webp" />
                                </Link>
                            )}
                            {developer.social.linkedin && (
                                <Link href={developer.social.linkedin}>
                                    <img src="/assets/linkedin.webp" />
                                </Link>
                            )}
                            {developer.social.twitter && (
                                <Link href={developer.social.twitter}>
